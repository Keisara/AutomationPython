...
usernameArray =["K.eisakyu@gmail.com",
                "emailFail@gmail.com",
                "K.eisakyu@gmail.com",
                "",
                "",
...
caseArray = ["Case 1: Login with a valid username and password | Expected Result: User is able to login",
             "Case 2: Login with an invalid username and invalid password | Expected Result: User is unable to login",
